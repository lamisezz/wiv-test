...
const polygonConfig ={
  method: 'get',
  url: `https://api.polygonscan.com/api?module=stats&action=tokensupply&contractaddress=${process.env.VUE_APP_CONTRACT_ADDRESS}&apikey=${process.env.VUE_APP_POLYGONSCANAPIKEY}`,
  headers: {
    'Content-Type': 'application/json'
  }
}

var web3 = new Web3(new Web3.providers.HttpProvider(process.env.VUE_APP_Web3HTTPSOCKETURL))
...
const addR = process.env.VUE_APP_CONTRACT_ADDRESS
